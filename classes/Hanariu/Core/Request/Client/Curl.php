<?php namespace Hanariu\Core\Request\Client;

class Curl extends \Hanariu\Request\Client\External {
	...
	public function _send_message(\Hanariu\Request $request, \Hanariu\Response $response)
	{
		...
		if (isset($error))
		{
			throw new \Hanariu\Exception('Error fetching remote :url [ status :code ] :error',
	...
	public function _set_curl_request_method(\Hanariu\Request $request, array $options)
	{
		switch ($request->method()) {
			case \Hanariu\Request::POST:
				$options[CURLOPT_POST] = TRUE;
				break;
			case \Hanariu\Request::PUT:
